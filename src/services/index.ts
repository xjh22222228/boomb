...
export async function updateFileContent(
  file: IFile,
  { content, branch = getLocalBranch(), isEncode = true }: Iupdate,
) {
...
export function getGiteeToken(code: string) {
  return post(
    `https://gitee.com/oauth/token?grant_type=authorization_code&code=${code}&client_id=${GITEE_CLIENT_ID}&redirect_uri=${REDIRECT_URI}`,
    {
